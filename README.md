...
Райтапы команды **UIT** для [alfaCTF 2026](http://alfactf.ru/) — открытого CTF от Альфа-Банка.
Автор: [sakost](https://github.com/sakost) (Константин Саженов).

В каждой папке задания лежат два файла: `ru.md` (основной, русский) и `en.md` (английский). Папка по умолчанию открывается на русской версии — это и есть `README.md` через симлинк.

🇬🇧 [English version →](README.en.md)

## Задания

| Задание | Категория | Сложность | Флаг | Языки |
|---------|-----------|-----------|------|-------|
...
- **Флаг:** для копипасты.
- **Главные выводы:** урок из задания, а не пересказ шагов.

Решающие скрипты (`solve/`) будут добавлены позже отдельным апдейтом.

## Команда

**UIT** — небольшая команда по CTF, играем за интерес.

## Лицензия

Тексты райтапов распространяются по лицензии [MIT](LICENSE) — © Константин Саженов, 2026.
