...
- В синтезированных схемах порядок байт в памяти, на дисплее и во вводе пользователя может быть перевёрнут независимо в каждом из этих мест. Всегда проверяйте направление эмпирически по одной известной паре «открытый текст — шифротекст», прежде чем доверять восстановленному ключу.
